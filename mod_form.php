...
//-------------------------------------------------------------------------------
        ...
        $mform->addElement('select', 'reissuecert', get_string('reissuecertificate', 'certificate'), $ynoptions);
        $mform->setDefault('reissuecert', 0);
	    $mform->setHelpButton('reissuecert', array('reissuecert', get_string('reissuecertificate', 'certificate'), 'certificate'));
...
//-------------------------------------------------------------------------------
        ...
        $mform->setHelpButton('orientation', array('orientation', get_string('orientation', 'certificate'), 'certificate'));
