...
// Add text
    ...
    cert_printtext($pdf, $x, $y+20, 'C', 'Times', '', 20, $certifystr);
    cert_printtext($pdf, $x, $y+36, 'C', 'Helvetica', '', 30, $studentname);
    cert_printtext($pdf, $x, $y+55, 'C', 'Helvetica', '', 20, $statementstr);
    ...
    if ($teachers = get_users_by_capability($context, 'mod/certificate:printteacher', '', $sort='u.lastname ASC','','','','',false)) {
        foreach ($teachers as $teacher) {
            $i++;
    cert_printtext($pdf, $sigx, $sigy+($i *4) , 'L', 'Times', '', 12, fullname($teacher));
}}}
