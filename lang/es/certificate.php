...
$string['reissuecert_help'] = 'Si eliges SI aqui, el certificado será re-emitido con una nueva fecha, calificación y número de código cada vez que el usuario clickeé sobre el link hacia el certificado. Nota:  Aunque una tabla mostrará sus fechas de emisión pasadas, no habrá un link para re-veerlo que sea mostrado al usuario. Sólo el último certificado emitido será mostrado en el reporte.';
