 ...
 * @return array                                                        *
 ************************************************************************/  
function certificate_get_teachers($user) {
    global $course, $certificate, $USER; 
...
function certificate_email_teachers($certificate) {
    ...
    if ($teachers = certificate_get_teachers($user)) {
...
/************************************************************************
 * Returns user information about issued certificates.                  *
 ************************************************************************/
